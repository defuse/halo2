use super::super::primitive::endoscale_pair;
    ...
    C::Base: PrimeFieldBits,
{
    ...
    pub(in crate::recursion) table: lookup::TableConfig<C::Base, K>,
...
impl<C: CurveAffine, const K: usize> UtilitiesInstructions<C::Base> for PubInputsConfig<C, K>
where
    C::Base: PrimeFieldBits,
{
...
impl<C: CurveAffine, const K: usize> PubInputsConfig<C, K>
where
    C::Base: PrimeFieldBits,
{
    #[allow(dead_code)]
    ...
    pub(crate) fn configure(
        ...
        base: (Column<Advice>, Column<Advice>),
        bits: (Column<Advice>, Column<Advice>),
        table: lookup::TableConfig<C::Base, K>,
    ) -> Self {
        let decomposition = {
        ...
        meta.lookup(|meta| {
            ...
            let default = {
                use super::super::primitive::endoscale_scalar;
                Expression::<C::Base>::Constant(endoscale_scalar([false; K]))
            };
...
impl<C: CurveAffine, const K: usize, const N: usize> PubInputsInstructions<C, K, N>
    for PubInputsConfig<C, K>
where
    C::Base: PubInputsLookup<K, N> + PrimeFieldBits,
{
...
mod tests {
    use super::{
        lookup::TableConfig, PubInputsConfig, PubInputsInstructions, PubInputsLookup, Word,
    };
    use crate::recursion::pub_inputs::primitive;
    ...
    impl PubInputsLookup<10, 1024> for pallas::Base {
        fn table() -> [([bool; 10], Self); 1024] {
            primitive::fp::TABLE
        }
    }

    impl PubInputsLookup<10, 1024> for vesta::Base {
        fn table() -> [([bool; 10], Self); 1024] {
            primitive::fq::TABLE
        }
    }
    ...
    impl Circuit<pallas::Base> for MyCircuit<pallas::Base> {
        type Config = PubInputsConfig<pallas::Affine, 10>;
        ...
        fn configure(meta: &mut ConstraintSystem<pallas::Base>) -> Self::Config {
            ...
            PubInputsConfig::<pallas::Affine, 10>::configure(
                meta,
                endoscalars,
                endoscalars_copy,
                word,
    ...
    impl Circuit<vesta::Base> for MyCircuit<vesta::Base> {
        type Config = PubInputsConfig<vesta::Affine, 10>;
        type FloorPlanner = SimpleFloorPlanner;
        ...
        fn configure(meta: &mut ConstraintSystem<vesta::Base>) -> Self::Config {
            ...
            PubInputsConfig::<vesta::Affine, 10>::configure(
                meta,
                endoscalars,
                endoscalars_copy,
                word,
    ...
    #[test]
    fn test_pub_inputs() {
        use crate::recursion::pub_inputs::primitive::endoscale_scalar_with_padding;
